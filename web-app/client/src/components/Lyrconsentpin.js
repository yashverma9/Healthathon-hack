        ...
        return (
            <div class="grid-container-lyrpin">
                <div class="grid-item grid-item-1-lyrpin">
                    ...
                    <div className="button--lyrhospital button--lyrhospital-lyrpin" onClick={() => this.nextPath('/lyr/hospital/data/pin')} >
                        <p className="button-text-lyrhospital">Confirm Pin</p>

                    </div>


                    <div className="backbutton-lyrhospital backbutton-lyrhospital-lyrpin" onClick={() => this.nextPath('/lyr/hospital/data')}>
                ...
                <div class="grid-item grid-item-2-lyrpin">
                </div>
